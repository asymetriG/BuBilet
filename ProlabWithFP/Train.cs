...
namespace ProlabWithFP
{
    ...
    {
        public int ID;
        public Train(int seat, Road road, string name, Personel driver, Personel servicer, Fuel fuel)
        {
        ...
        {
            route = new Route(road.roadway[0], road.roadway[road.roadway.Count - 1], "railway");
